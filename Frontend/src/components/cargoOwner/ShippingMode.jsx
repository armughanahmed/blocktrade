...
class ShippingMode extends PureComponent {
        ...
        <div className="added-consignments">
          <div className="card w-100" style={{ marginTop: 30 }}>
            <div className="card-body" style={{ padding: "45px" }}>
              <h5>Mode: {con.mode}</h5>
              <p>
                <strong>Movement type:</strong> {con.movementType}
              </p>
              <p>
                <strong>Package type:</strong> {con.type}
              </p>
              <p>
                <strong>Quantity:</strong> {con.quantity}
              </p>
              <p>
                <strong>Length:</strong> {con.length}
              </p>
              <p>
                <strong>Width:</strong> {con.width}
              </p>
              <p>
                <strong>Height:</strong> {con.height}
              </p>
              <p>
                <strong>Weight:</strong> {con.weight}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="added-consignments">
          <div className="card w-100" style={{ marginTop: 30 }}>
            <div className="card-body" style={{ padding: "45px" }}>
              ...
              <p>
                <strong>Package type:</strong> {con.packageType}
              </p>
              <p>
                <strong>Quantity:</strong> {con.quantity}
              </p>
              <p>
                <strong>Container size:</strong> {con.containerHeight}
              </p>
              <p>
                <strong>Container description:</strong>{" "}
                {con.containerDescription}
              </p>
            </div>
          </div>
        </div>
  ...
  sendConsignments = () => {
    ...
    console.log(obj);
    this.props.getConsignments(
      this.state.consignments,
      this.obj,
      this.state.consignments1
    );
  };
    ...
    if (this.state.mode === "ocean-lcl") {
      ...
      return (
        <OpenFcl
          mode={this.state.mode}
          movementType={this.state.movementType}
          consignments1={this.state.consignments1}
          childCallback={this.childCallback}
        />
      );
    }
        ...
        <div className="row">
          <div className="col">
            <input
              ...
              value={this.state.pickupCountry}
              onChange={(e) => this.updatePickupCountry(e)}
              placeholder="Country"
            />
            <br />
          </div>
          <div className="col">
            <input
              ...
              onChange={(e) => this.updatePickupCity(e)}
              placeholder="City"
            />
            <br />
          </div>
        ...
        <div className="row">
          <div className="col">
            <textarea
              ...
              onChange={(e) => this.updatePickupAddress(e)}
      ...
      <div>
        ...
        <div className="row">
          <div className="col">
            <input
              className="form-control"
              value={this.state.deliverCountry}
              onChange={(e) => this.updateDeliverCountry(e)}
              placeholder="Country"
            />
            <br />
          </div>
          <div className="col">
            <input
              className="form-control"
              value={this.state.deliverCity}
              onChange={(e) => this.updateDeliverCity(e)}
              placeholder="City"
            />
            <br />
          </div>
        ...
        <div className="row">
          <div className="col">
            <textarea
              cols="79"
              className="form-control"
              value={this.state.deliverAddress}
              onChange={(e) => this.updateDeliverAddress(e)}
          ...
          <div className="card-body">
            ...
            <form action="#">
                ...
                <div className="col-lg-6">
                  <div class="form-group">
                    ...
                    <select
                      ...
                      onChange={(e) => this.updateMovementType(e)}
                      required
                    >
              ...
              {this.state.movementType === "d2d"
                ...
                : null}
              {this.state.movementType === null && this.show()}
              {this.state.movementType === "p2p" && this.show()}
            </form>
            ...
            {this.state.consignments.length > 0 && (
              <div className="main-added-consignments">
                <h3>Ocean LCLs</h3>
                <div className="row">
                  {this.state.consignments.map((con) => this.displayLcl(con))}
                </div>
              </div>
            )}
            {this.state.consignments1.length > 0 && (
              <div className="main-added-consignments">
                <h3>Ocean FCLs</h3>
                <div className="row">
                  {this.state.consignments1.map((con) => this.displayFcl(con))}
                </div>
              </div>
            )}
            {/* { this.state.consignments.length > 0 &&   
