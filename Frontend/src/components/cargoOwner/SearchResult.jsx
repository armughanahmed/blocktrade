...
<div className="row">
                ...
                <div className="col-lg-6 col-sm-6">
                  <div className="card">
                      <div className="card-body">
                          <h4 className="text-center">Selected schedule details</h4>
                          <div className="row">
                           ...
                           <div className="text-center">
                                <button className="btn btn-primary text-center" onClick={this.sendSelectedSchedule}>Enter consignment details</button>
                           </div>
